export const S = {
  page: { minHeight:"100vh", color:"#fff", fontFamily:"system-ui,sans-serif", maxWidth:480, margin:"0 auto", padding:"0 16px 80px", position:"relative" as const, zIndex:2 },
  btn:  { background:"linear-gradient(135deg,#6366f1,#818cf8)", color:"#fff", border:"none", borderRadius:12, padding:"12px 24px", fontSize:16, fontWeight:600, cursor:"pointer", width:"100%" as const, marginTop:8, boxShadow:"0 4px 20px rgba(99,102,241,.3)" },
